...
namespace MangaERP.Shared.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260726152138_Phase2TaskAssignmentEnhancements")]
    partial class Phase2TaskAssignmentEnhancements
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MangaERP.Task.Domain.Entities.TaskAssignmentAttempt", b =>
                {
                    ...
                    b.HasIndex(new[] { "TaskId", "AssignmentRole" }, "IX_TaskAssignmentAttempts_TaskId_AssignmentRole_Accepted")
                        .IsUnique()
                        .HasFilter("\"Status\" = 'Accepted'");

                    b.HasIndex(new[] { "TaskId", "AssignmentRole" }, "IX_TaskAssignmentAttempts_TaskId_AssignmentRole_PendingAcceptance")
                        .IsUnique()
