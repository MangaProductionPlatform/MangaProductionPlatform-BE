...
namespace MangaERP.Shared.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260730150000_FixSubmissionStatusCheckConstraint")]
    partial class FixSubmissionStatusCheckConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MangaERP.Chapter.Domain.Entities.PageTask", b =>
                {
                    ...
                    b.Property<Guid?>("BackupAssistantId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("CancellationCategory")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<Guid?>("CurrentAssignmentAttemptId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("HalfwayWarningSentAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<Guid?>("PreviousAssignedAssistantId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("PrimaryAssistantId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("ReassignmentRequiredAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("RecreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("RecreatedByUserId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TakeoverStatus")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
            ...
            modelBuilder.Entity("MangaERP.Identity.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<int>("DeadlineWarningCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("MangaERP.Shared.Domain.Entities.AuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MangaERP.Submission.Domain.Entities.SeriesSubmission", b =>
                {
                    ...
                    b.ToTable("SeriesSubmissions", null, t =>
                        {
                            t.HasCheckConstraint("CK_SeriesSubmissions_Status", "\"Status\" IN ('Draft', 'Pending_Tantou_Review', 'Tantou_Revision_Required', 'Pending_EB_Review', 'Requires_Revision', 'Editorial_Rejected_To_Tantou', 'Mangaka_Revision_Required', 'EB_Approved', 'EB_Rejected', 'Conflict_Escalated')");
                        });
                });
            ...
            modelBuilder.Entity("MangaERP.Task.Domain.Entities.TaskAssignmentAttempt", b =>
                {
                    ...
                    b.HasIndex(new[] { "TaskId", "AssistantId" }, "IX_TaskAssignmentAttempts_TaskId_AssistantId_Active")
                        .IsUnique()
                        .HasFilter("\"Status\" = 'Accepted'");
            ...
            modelBuilder.Entity("MangaERP.Task.Domain.Entities.TaskCheckpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("OffsetMinutesFromAcceptance")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MangaERP.Task.Domain.Entities.TaskProgressUpdate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("AssignmentAttemptId")
                        .HasColumnType("uuid");
